         ...
         <form id="projectForm" class="space-y-10" action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <!-- <div class="section-divider">
               ...
               <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                     <label for="vendor_type">Work/Service Model *:</label>
                     <select id="vendor_type" name="vendor_type" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-custom-blue focus:border-custom-blue transition-all select2">
    ...
    if (vendorId) {
        $.ajax({
            ...
            success: function (res) {
                let html = '';
                if (res.length > 0) {
                    html += '<option value="">Select Sub Vendor Type</option>'; // default option
                ...
                $('#sub_vendor_type_dropdown').html(html);
            }
        });
    } else {
