...
<div class="ck-wrap" x-data="{ activeProject: null, showCallModal: false }">
  ...
  <!-- <div x-show="activeProject" x-cloak class="ck-backdrop" x-transition>
    <div class="ck-modal w-100 animate-fade-in" style="max-width: 920px; max-height: 90vh; overflow:auto; position:relative;">
      <button @click="activeProject = null" class="btn btn-link ck-close p-0">
        <span class="material-icons">close</span>
      </button>

      <div class="p-4 p-md-5" x-data="{ showTextarea:false }">
        <h2 class="h4 fw-bold text-dark border-bottom pb-3 mb-4" x-text="activeProject.project_name"></h2>

        <div class="mb-4">
          <h3 class="section-title h6">Project Information</h3>
          <div class="row g-3 ck-meta">
            ...
            <div class="col-md-6"><p>💰 Budget</p><p x-text="activeProject.budget_range"></p></div>
            <div class="col-md-6"><p>⏱ Timeline</p><p x-text="activeProject.expected_timeline"></p></div>
          </div>
        </div>

        <div class="mb-4">
          <h3 class="section-title h6">Submission Info</h3>
          ...
          <div class="ck-meta">
            ...
            <template x-if="activeProject.boqFile">
              <a
                ...
                download target="_blank" class="btn btn-soft btn-sm">
        ...
        <div class="mb-4">
          <h3 class="section-title h6">Contact Information</h3>
          <div class="row g-3 ck-meta">
        ...
        <div class="pt-3 border-top">
          ...
          <div class="mt-3" x-show="showTextarea" x-transition x-cloak>
            ...
            <button
              @click="submitRemarks(activeProject.id, $refs.remarks.value)"
