...
<head>
  ...
  <title>@yield('title', 'Calling • ConstructKaro')</title>
    ...
    <aside class="sidebar d-none d-lg-block">
      ...
      <div class="nav-section">
        ...
        <a class="side-link " href="">
          <i class="bi bi-speedometer2 side-icon"></i> Dashboard
        </a>
      </div>

      <div class="nav-section">
        <div class="title">Vendor Details</div>
        <a class="side-link {{ request()->routeIs('callingvendorlistadd') ? 'active' : '' }}" href="{{ route('callingvendorlistadd') }}">
          <i class="bi bi-people side-icon"></i> Vendor Add
        </a>
      </div>
    </aside>
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end shadow">
            <li class="dropdown-item-text text-muted small px-3">
              Signed in as <strong>Engineer</strong>
            </li>
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileNav">
        ...
        <div class="offcanvas-body d-flex flex-column">
          <div class="list-group mb-3">
            ...
            <a class="list-group-item list-group-item-action" href="{{ route('callingvendorlistadd') }}">Vendor Add</a>
          </div>
